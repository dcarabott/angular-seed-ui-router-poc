...
export class SeedConfig {
  ...
  MINI_APP_MODULE = `${this.BOOTSTRAP_DIR}/${this.NG_FACTORY_FILE}`;
  /**
  ...
  SYSTEM_CONFIG_DEV: any = {
    paths   : {
      ...
      '@uirouter/sticky-states': 'node_modules/@uirouter/sticky-states/_bundles/ui-router-sticky-states.js',
  ...
  SYSTEM_BUILDER_CONFIG: any = {
    ...
    packageConfigPaths : [
      ...
      join('node_modules', '@uirouter', '*', 'package.json')
    ...
    paths              : {
      ...
      '@uirouter/core/lib/common.js': 'node_modules/@uirouter/core/lib/common/index.js',
    ...
    packages           : {
      ...
      '@uirouter/sticky-states'          : {
        main            : '_bundles/ui-router-sticky-states.js',
        defaultExtension: 'js'
      },
      '@uirouter/core'                   : {
